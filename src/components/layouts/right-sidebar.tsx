...
const AI_AGENTS: AIAgent[] = [
  {
    name: 'Orion',
    description: 'Always scanning the space, finding patterns, and uncovering hidden data points.',
    action: 'Insight',
  ...
  {
    name: 'Nova',
    description: 'A sudden, bright burst of energy that triggers actions and brings things to life.',
    action: 'Act',
  ...
  {
    name: 'Pulsar',
    description: 'Named after the cosmic clocks of the universe; keeps the steady, real-time beat and monitors health.',
    action: 'Protect',
  ...
  {
    name: 'Nebula',
    description: 'Where new stars are born; handles continuous growth, adaptation, and shaping the future.',
    action: 'Improve',
